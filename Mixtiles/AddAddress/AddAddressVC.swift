...
//protocol AddressDictDelegate: class {
//    func AddressDict(dict: NSMutableDictionary)
//}
...
class AddAddressVC: BaseViewController, UITextFieldDelegate {
    ...
    //    weak var AddreesDelegae: AddressDictDelegate?
    ...
    {
        self.lblHeader.text = LocalizedLanguage(key: "lbl_title_add_address", languageCode: lanCode)
